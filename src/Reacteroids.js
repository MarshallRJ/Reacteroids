...
const shortcuts = [
  ...
  {
    description: "Redo",
    shortcut: isAppleDevice ? `${commandKey}+shift+z` : `${commandKey}+y`,
  },
...
export default class Reacteroids extends Component {
  ...
  handleKeys(value, e) {
    e.preventDefault();
    let currentKeys;
    if (value) currentKeys = this.handleKeyDown(e);
    else currentKeys = this.handleKeyUp(e);
  ...
  componentDidMount() {
    ...
    this.backgroundImage.src =
      "https://img.freepik.com/premium-photo/glowing-spaceship-orbits-planet-starry-galaxy-generated-by-ai_1038396-45.jpg";
